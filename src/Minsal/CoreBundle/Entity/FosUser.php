 ...
 * FosUser
 *
 * @ORM\Table(name="fos_user", uniqueConstraints={@ORM\UniqueConstraint(name="uniq_957a647992fc23a8", columns={"username_canonical"}), @ORM\UniqueConstraint(name="uniq_957a6479a0d96fbf", columns={"email_canonical"})}, indexes={@ORM\Index(name="IDX_957A647971B61351", columns={"establecimiento_id"})})
 * @ORM\Entity
 */
class FosUser
{
